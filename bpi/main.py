...
class BinanceLite(object):
    ...
    def cancel_all_open_orders(self, **params):
        ...
        #     print(self.cancel_order(symbol=symbol, orderId=open_order['orderId']))
...
# print(assets)
# open_order = cl.create_order(symbol=BinanceLite.SYMBOL_BTCUSDT,
...
# open_orders = cl.get_open_orders(symbol=BinanceLite.SYMBOL_BTCUSDT)
# print(open_orders)

print(cl.cancel_all_open_orders(symbol=BinanceLite.SYMBOL_BTCUSDT))